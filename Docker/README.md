...
The simplest way to run this repository is to use the Docker container of
[Kaggle](https://www.kaggle.com/notebooks). It allows users to run a Python Notebook in the cloud against our competitions and datasets without having to download data or set up their environment.

Since one of the purposes of this repository is to be self-contain (no pun intended), this README file have the instructions copied from the [original Kaggle readme file](https://github.com/Kaggle/docker-python/blob/main/README.md). 
